...
<body>
	<nav id="sidebar" class="sidebar js-sidebar">
		<div class="sidebar-content js-simplebar">
			<a class="sidebar-brand" href="/product/home"> <span
			...
			<ul class="sidebar-nav">
				...
				<li class="sidebar-item active"><a class="sidebar-link"
					href="/product/listProducts"> <i class="align-middle"
						data-feather="sliders"></i> <span class="align-middle">Products</span>
				</a></li>

				<li class="sidebar-item"><a class="sidebar-link"
					href="/category/list"> <i class="align-middle"
						data-feather="user"></i> <span class="align-middle">Category</span>
				</a></li>
				...
				<li class="sidebar-item"><a class="sidebar-link"
					href="/product/insert"> <i class="align-middle"
						data-feather="check-square"></i> <span class="align-middle">Products</span>
				</a></li>

				<li class="sidebar-item"><a class="sidebar-link"
					href="/category/insert"> <i class="align-middle"
						data-feather="grid"></i> <span class="align-middle">Category</span>
				</a></li>
				...
				<ul class="navbar-nav navbar-align">
					...
					<li class="nav-item dropdown"><a
						...
						<div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0"
							...
							<div class="dropdown-menu-header">
								<div class="position-relative">New Messages</div>
							</div>
							<div class="list-group">
								<a href="#" class="list-group-item">
									<div class="row g-0 align-items-center">
					...
					<li class="nav-item dropdown"><a
						...
						href="#" data-bs-toggle="dropdown"> <img
							src="/admin/img/avatar.jpg" class="avatar img-fluid rounded me-1"
							alt="Charles Hall" /> <span class="text-dark">Charles
								Hall</span>
					</a>
